...
class BigramLanguageModel(nn.Module):
    ...
    def generate(self, idx, max_new_tokens):
        ...
        for _ in range(max_new_tokens):
            ...
            idx_cond=idx[:, -block_size:] # now that we are using positional embedding we can not have more than block_size otherwise the positional_embedding table will run out of scope because its only till block size
            # get the predictions
